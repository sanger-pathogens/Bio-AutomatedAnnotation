package Bio::AutomatedAnnotation::External::LSFInterProScan;
...
Run interproscan via LSF jobs
   ...
   my $obj = Bio::AutomatedAnnotation::External::LSFInterProScan->new(
...
sub _report_errors {
    ...
    if ( scalar @errors != 0 ) {
        Bio::AutomatedAnnotation::AutomatedAnnotation::LSFJobFailed->throw( error => "The following jobs failed: ", join( ",", @errors ) );
    }
