package Bio::AutomatedAnnotation::CommandLine::CreatePanGenome;
...
sub run {
    ...
    my $combined_proteome_obj = Bio::AutomatedAnnotation::CombinedProteome->new(
   ...
   my $blast_database= Bio::AutomatedAnnotation::External::Makeblastdb->new(fasta_file => 'clustered.faa');
   $blast_database->run();
   
   print "Blasting all against all:\n";
   my $blastp_obj =  Bio::AutomatedAnnotation::External::Blastp->new(
